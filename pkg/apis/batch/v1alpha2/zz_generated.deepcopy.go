...
func (in *JobSpec) DeepCopyInto(out *JobSpec) {
	*out = *in
	...
	if in.Tasks != nil {
		...
		*out = make([]TaskSpecWithSize, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *LifecyclePolicy) DeepCopyInto(out *LifecyclePolicy) {
	*out = *in
	if in.Events != nil {
		...
		*out = make([]v1alpha1.Event, len(*in))
		copy(*out, *in)
	}
	if in.ExitCode != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TaskSpecWithSize) DeepCopyInto(out *TaskSpecWithSize) {
	*out = *in
	in.TaskSpec.DeepCopyInto(&out.TaskSpec)
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TaskSpecWithSize.
func (in *TaskSpecWithSize) DeepCopy() *TaskSpecWithSize {
	if in == nil {
		return nil
	}
	out := new(TaskSpecWithSize)
	in.DeepCopyInto(out)
	return out
}
