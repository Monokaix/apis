...
import (
	...
	apisbatchv1alpha2 "volcano.sh/apis/pkg/apis/batch/v1alpha2"
	...
	batchv1alpha2 "volcano.sh/apis/pkg/client/listers/batch/v1alpha2"
)
...
type JobInformer interface {
	...
	Lister() batchv1alpha2.JobLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.BatchV1alpha2().Jobs(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.BatchV1alpha2().Jobs(namespace).Watch(context.TODO(), options)
			},
		},
		&apisbatchv1alpha2.Job{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *jobInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisbatchv1alpha2.Job{}, f.defaultInformer)
}

func (f *jobInformer) Lister() batchv1alpha2.JobLister {
	return batchv1alpha2.NewJobLister(f.Informer().GetIndexer())
}
