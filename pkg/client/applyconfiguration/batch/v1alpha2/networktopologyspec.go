...
type NetworkTopologySpecApplyConfiguration struct {
	Mode               *batchv1alpha2.NetworkTopologyMode `json:"mode,omitempty"`
...
func (b *NetworkTopologySpecApplyConfiguration) WithMode(value batchv1alpha2.NetworkTopologyMode) *NetworkTopologySpecApplyConfiguration {
	b.Mode = &value
	return b
}
