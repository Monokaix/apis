...
type TaskSpecApplyConfiguration struct {
	...
	TopologyPolicy *batchv1alpha2.NumaPolicy           `json:"topologyPolicy,omitempty"`
...
func (b *TaskSpecApplyConfiguration) WithTopologyPolicy(value batchv1alpha2.NumaPolicy) *TaskSpecApplyConfiguration {
