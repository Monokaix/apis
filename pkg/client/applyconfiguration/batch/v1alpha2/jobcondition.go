...
type JobConditionApplyConfiguration struct {
	Status             *batchv1alpha2.JobPhase `json:"status,omitempty"`
...
func (b *JobConditionApplyConfiguration) WithStatus(value batchv1alpha2.JobPhase) *JobConditionApplyConfiguration {
	b.Status = &value
	return b
}
