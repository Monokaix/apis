...
type JobSpecApplyConfiguration struct {
	...
	Tasks                   []TaskSpecWithSizeApplyConfiguration   `json:"tasks,omitempty"`
...
func (b *JobSpecApplyConfiguration) WithTasks(values ...*TaskSpecWithSizeApplyConfiguration) *JobSpecApplyConfiguration {
	for i := range values {
		if values[i] == nil {
