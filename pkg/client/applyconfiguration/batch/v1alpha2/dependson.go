...
type DependsOnApplyConfiguration struct {
	...
	Iteration *batchv1alpha2.Iteration `json:"iteration,omitempty"`
}
...
func (b *DependsOnApplyConfiguration) WithIteration(value batchv1alpha2.Iteration) *DependsOnApplyConfiguration {
	b.Iteration = &value
	return b
}
