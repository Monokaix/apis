...
type JobLister interface {
	...
	List(selector labels.Selector) (ret []*batchv1alpha2.Job, err error)
...
type jobLister struct {
	listers.ResourceIndexer[*batchv1alpha2.Job]
}

// NewJobLister returns a new JobLister.
func NewJobLister(indexer cache.Indexer) JobLister {
	return &jobLister{listers.New[*batchv1alpha2.Job](indexer, batchv1alpha2.Resource("job"))}
}

// Jobs returns an object that can list and get Jobs.
func (s *jobLister) Jobs(namespace string) JobNamespaceLister {
	return jobNamespaceLister{listers.NewNamespaced[*batchv1alpha2.Job](s.ResourceIndexer, namespace)}
}
...
type JobNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*batchv1alpha2.Job, error)
